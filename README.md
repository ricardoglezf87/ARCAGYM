...
- Seguimiento diario de dieta por raciones con equivalencias fijas, estimacion de cantidades por texto, planes configurables por fecha, estado consumido/restante y propuestas para el resto del dia.
